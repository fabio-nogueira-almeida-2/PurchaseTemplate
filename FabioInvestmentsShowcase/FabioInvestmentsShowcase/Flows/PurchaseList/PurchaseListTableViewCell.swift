...
final class PurchaseListTableViewCell: UITableViewCell {
    ...
    func setup(with card: PurchaseListDTO.Card) {
    ...
    private func createFieldView(field: PurchaseListDTO.Field) -> UIView {
