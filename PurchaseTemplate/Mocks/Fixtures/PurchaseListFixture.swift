//
//  PurchaseListFixture.swift
//  PurchaseTemplate
//
//  Mock fixture data for Purchase List (OffersList) screen
//

import Foundation

struct PurchaseListFixture {
    static func mockResponse(productId: String, productTypeId: String) -> PurchaseListService.Response {
        let isRoyalties = productTypeId == "2"
        
        if isRoyalties {
            // Royalties Investment data
            return PurchaseListService.Response(
                data: [
